...
void setup() {
 ...
 // palette[1] = matrix.Color(0,0,255);       //blue
    palette[2] = matrix3.Color(0,0,255);    //purple
 // palette[3] = matrix.Color(0,0,255);       //green
 // palette[4] = matrix.Color(0,0,255);   //white
 // palette[5] = matrix.Color(0,255,255);       //red
    palette[6] = matrix1.Color(0,0,255);    //yellow 
    palette[7] = matrix2.Color(0,0,255);    //cyan
